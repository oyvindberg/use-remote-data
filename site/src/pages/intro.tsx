    ...
    <Layout title={`Getting started`} description="Getting started">
        <main className="container">
            ...
            <div>
                ...
                <br />
                <br />
                All types are tracked, and in the render prop given to <code>WithRemoteData</code> we
                use <Link to="https://levelup.gitconnected.com/crazy-powerful-typescript-tuple-types-9b121e0a690c">tuple destructuring </Link>
                to pick apart the values again.
                <br />
                <br />
                <Snippet snippet="combine" />
                <h3>A note about Typescript tooling</h3>
                The Typescript compiler knows everything about the types here. As does Intellij, but it's currently not flawless.
                This video demonstrates how you can press <code>ctrl</code> while hovering with the mouse to see types.
                It also demonstrates how you sometimes need to write types yourself if you want them written down.
                <br/>
                <br/>
            ...
            <div>
                ...
                <code>use-remote-data</code> supports seamless invalidation and refreshing of data,
                by specifying the optional<code>ttlMillis</code> parameter to <code>use-remote-data</code>.
                You specify how many milliseconds the data is valid after it is received.
                <br/>
                <br/>
                Once the data is deemed invalidated, you are informed through the second <code>isInvalidated</code>
                argument in the render prop given to <code>WithRemoteData</code>.
                With that bit of information you can for instance render the old data as gray or deactivated while
                the application is waiting for fresh data.
                <br/>
                <br/>
            ...
            <div>
                ...
                A very common use-case is that you have an app with for instance many routes.
                Each route will need some different subsets of data, and you want to keep as much data as possible cached
                when the user navigates back and forth.

                <br/>
                <br/>
                <code>use-remote-data</code> supports this use-case very well because <code>RemoteDataStore</code> is
                <em>Lazy</em> and <em>Caching</em>.
                You can define all the relevant data stores high up in the hierarchy, and data lifetimes neatly follows component lifecycles.
                You can then freely pass a store to any number of code paths, and the data will only be fetched once.
                ...
                Typically you may want to draw an outline of the application before you get any data,
                and the components which do that should probably accept a<code>RemoteDataStore</code> in props.
                <br/>
                <br/>
                In most other cases it's better to just pass the value after it has been retrieved,
                for the singular reason that it's simpler.
                <Snippet snippet="use_twice" />
            </div>
            <div>
                <h2>Handling failure</h2>
                Another defining feature of <code>use-remote-data</code> is the principled error handling and the retry functionality.
                Developers typically make an ad-hoc attempt at the former, while not many have the discipline to also do the latter.
                <br/>
                <br/>
                This example creates a <code>Promise</code> which fails every tenth time it is called.
                The sometimes-failing store is combined with another store which never fails, and you should hit <em>retry </em>
